...
if st.session_state["authenticated"]:
     ...
     with st.expander("##### 5- STRATEGY: Winning Moves"):
          session_forms.session_five(email, company_id_selected)
     with st.expander("##### 6- CASH: Cash Conversion Cycle"):
          session_forms.session_six(email, company_id_selected)
     with st.expander("##### 7- CASH: The Power of Iniciatives"):
          session_forms.session_seven_cash(email, company_id_selected)
     with st.expander("##### 8- EXECUTION: Alignment (WWW)"):
          session_forms.session_eight(email, company_id_selected)
     with st.expander("##### 8- EXECUTION: Winning Moves"):
          session_forms.session_eight_winning_moves(email, company_id_selected)
     with st.expander('##### 8- EXECUTION+: Anual Company Priorities'):
          session_forms.session_eight_anual_company_priorities(email, company_id_selected)
     with st.expander('##### 8- EXECUTION+: Quarterly Company Priorities'):
          session_forms.session_eight_quarterly_company_priorities(email, company_id_selected)
     with st.expander('##### 8- EXECUTION+: Individual Priorities'):
          session_forms.session_eight_priorities_individual(email, company_id_selected)
